          ...
          return (
            ...
            >
              <div
                ...
                className={`${
                  cardIndex === index && "bg-white shadow-2xl"
                } w-[350px] h-[350px] flex flex-col justify-center items-center mx-auto pt-[65px] text-center rounded-[12px] cursor-pointer transition-all`}
              >
                {/* card icon */}
                <div className="mb-6">
                  <img src={icon} alt="" />
                ...
                {/* card title */}
                <div className="mb-3 text-[39px] font-medium">{title}</div>
                {/* card subtitle */}
